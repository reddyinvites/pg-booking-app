...
# ❌ REMOVED DUPLICATES LINE (IMPORTANT FIX)
...
for (pg_name, location), group in grouped:
    ...
    row = group.iloc[0]  # take first row for PG info
    ...
    results.append({
        ...
        "location": location,
        "price": price,
        "beds": int(group["available_beds"].sum()),  # ✅ total beds from all rooms
        "score": score,
        "reasons": reasons,
        "cons": cons,
        "pain": pain_score,
